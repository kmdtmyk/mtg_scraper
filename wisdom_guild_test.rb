...
class WisdomGuildTest < Test::Unit::TestCase
  ...
  sub_test_case 'get' do
    ...
    test 'top level property' do
      record = WisdomGuild.get('AKH223')
      assert_equal("木端+微塵", record[:name])
      assert_equal("Cut+Ribbons", record[:english_name])
      assert_equal(426925, record[:multiverseid])
    end
    ...
    test 'Creature' do
      ...
      assert_equal(expect, WisdomGuild.get('GTC113')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('FUT153')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('M15110')[:details])
    end
    ...
    test 'Instant' do
      ...
      assert_equal(expect, WisdomGuild.get('ALA033')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('FUT042')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('LRW194')[:details])
    end
    ...
    test 'Sorcery' do
      ...
      assert_equal(expect, WisdomGuild.get('DKA082')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('IMA042')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('ROE001')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('M10128')[:details])
    end
    ...
    test 'Enchantment' do
      ...
      assert_equal(expect, WisdomGuild.get('RTR003')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('MIR055')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('MOR058')[:details])
    end
    ...
    test 'Artifact' do
      ...
      assert_equal(expect, WisdomGuild.get('M13200')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('KLD222')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('KLD234')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('MOR144')[:details])
    end
    ...
    test 'Planeswalker' do
      ...
      assert_equal(expect, WisdomGuild.get('M11058')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('AKH204')[:details])
    end
    ...
    test 'Land' do
      ...
      assert_equal(expect, WisdomGuild.get('RIX192')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('OGW183')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('RTR247')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('FUT174')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('CSP145')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('CSP151')[:details])
    end
    ...
    test 'split' do
      ...
      assert_equal(expect, WisdomGuild.get('APC128')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('DGM135')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('AKH223')[:details])
    end
    ...
    test 'levelup' do
      ...
      assert_equal(expect, WisdomGuild.get('ROE112')[:details])
    end
    ...
    test 'flip' do
      ...
      assert_equal(expect, WisdomGuild.get('CHK070')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('SOK035')[:details])
    end
    ...
    test 'double_faced' do
      ...
      assert_equal(expect, WisdomGuild.get('ISD051')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('ORI060')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('SOI088')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('XLN191')[:details])
      ...
      assert_equal(expect, WisdomGuild.get('SOI243')[:details])
    end
